...
DIR = '/Users/marcoscorrea/Downloads/OneDrive_1_08-09-2026/'
CATALOG = '/Users/marcoscorrea/comparativo-ppo/catalog.json'
OUT = '/tmp/hap_parsed.json'
...
# ---------------- carga ----------------
# Carga Hapvida 08/09-30/09. Nao vieram os arquivos Individual (PF) nem o de
# Joinville/ACIRP: pela regra do usuario, o que nao veio fica como estava.
FILES = [
    ('20260908 a 20260930 - Super Simples 1 vida.pdf', False, dict(vmin=1, vmax=1)),
    ('20260908 a 20260930 - Super Simples 2 a 29 vidas.pdf', False, dict(vmin=2, vmax=29)),
    ('20260908 a 20260930 - PME.pdf', False, dict(vmin=30, vmax=99)),
]
...
if __name__ == '__main__':
    ...
    spot_print(result)
    # report_acirp()  # arquivo ACIRP nao veio nesta carga
