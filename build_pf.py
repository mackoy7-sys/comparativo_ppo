...
DIR = '/Users/marcoscorrea/Downloads/OneDrive_2_08-09-2026/'
CATALOG = '/Users/marcoscorrea/comparativo-ppo/catalog.json'
OUT = '/tmp/pf_parsed.json'
...
# ---------------- carga ----------------
# Carga Individual (PF) de 08/09. ORDEM IMPORTA: os arquivos de 08/09 de
# Uberaba/Joinville vem por ULTIMO para sobrepor a tabela de 01/07 dessas duas
# pracas (no merge, a ultima leitura da mesma chave vence).
FILES = [
    ('20260701 a 20260930 - Tabela Promocional Individual - Ambulatorial.pdf', True, {}),
    ('20260901 a 20260930 - Individual (4).pdf', True, {}),
    ('20260901 a 20260930 - Individual - Sertãozinho.pdf', True, {}),
    ('20260908 a 20260930 - Individual_Uberaba e Joinville.pdf', True, {}),
    ('20260908 a 20260930 - Tabela Promocional Individual - Ambulatorial_Uberaba e Joinville.pdf', True, {}),
]
...
if __name__ == '__main__':
    ...
    spot_print(result)
    # report_acirp()  # nao vem nesta remessa
