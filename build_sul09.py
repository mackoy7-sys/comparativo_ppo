...
def load_all():
    # Carga Sul 08/09-30/09. So veio o pacote PR/SC (Balneario Camboriu, Curitiba,
    # Londrina, Maringa). O do RS (Canoas, Novo Hamburgo, Sao Leopoldo, Porto
    # Alegre) nao veio nesta remessa e fica como estava.
    D3 = '/Users/marcoscorrea/Downloads/OneDrive_3_08-09-2026/'
    files = [
        (D3+'20260908 a 20260930 - Individual.pdf', True, {}),
        (D3+'Tabela Individual - Ambulatorial - 20260908 a 20260930.pdf', True, {}),
        (D3+'20260908 a 20260930 - PME.pdf', False, dict(vmin=30, vmax=99)),
        (D3+'20260908 a 20260930 - Super Simples.pdf', False, dict(vmin=2, vmax=29)),
    ]
    result = {}
...
if __name__ == '__main__':
    result = load_all()
    json.dump(result, open('/tmp/sul09_parsed.json', 'w'), ensure_ascii=False, indent=1)
