...
D = '/Users/marcoscorrea/Downloads/OneDrive_6_08-09-2026/'
...
def load_all():
    ...
    # Individual (PF) das 9 pracas NDI. Os arquivos de Sorocaba (01/09) vem por
    # ULTIMO para sobrepor: no merge, a ultima leitura da mesma chave vence.
    files = {
        ...
        'ind_soro': ('20260901 a 20260930 - Individual - NDI Sede - Sem Desconto - Sorocaba.pdf', 'ind', dict(mei=False, tipo='Individual')),
        'amb_soro': ('20260901 a 20260930 - Individual Ambulatorial - NDI Sede - Sem Desconto - Sorocaba.pdf', 'amb', dict(mei=False, tipo='Individual')),
    }
...
if __name__ == '__main__':
    ...
    json.dump(result, open('/tmp/ndipf_parsed.json', 'w'), ensure_ascii=False, indent=1)
