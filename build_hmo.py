...
def load_all():
    ...
    files = {
        'ss_demais': ('20260908 a 20260930 - Super Simples 2 a 29 vidas - Demais Empresas [HMO].pdf', 'emp', dict(mei=False, vmin=2, vmax=29, tipo='Empresarial')),
        'ss_mei':    ('20260908 a 20260930 - Super Simples 2 a 29 vidas - MEI [HMO].pdf', 'emp', dict(mei=True, vmin=2, vmax=29, tipo='Empresarial')),
        'pme_comp':  ('20260908 a 20260930 - PME - Compulsório v2 [HMO].pdf', 'emp', dict(mei=False, vmin=30, vmax=99, tipo='Empresarial', contratacao='Compulsório')),
        'pme_adesao':('20260908 a 20260930 - PME - Adesão v2 [HMO].pdf', 'emp', dict(mei=False, vmin=30, vmax=99, tipo='Empresarial', contratacao='Adesão')),
        'ss_1vida':  ('20260908 a 20260930 - Super Simples 1 Vida [HMO].pdf', 'emp', dict(mei=False, vmin=1, vmax=1, tipo='Empresarial')),
    }
...
if __name__ == '__main__':
    ...
    json.dump(result, open('/tmp/hmo_parsed.json', 'w'), ensure_ascii=False, indent=1)
